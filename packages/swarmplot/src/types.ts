...
import { PropertyAccessor, ValueFormat, Theme, MotionProps, Box, Margin } from '@stu-dev/nivo-core'
...
import { ScaleLinear, ScaleLinearSpec, ScaleTime, ScaleTimeSpec, TicksSpec } from '@stu-dev/nivo-scales'
