...
import { curveFromProp } from '@stu-dev/nivo-core'
import { OrdinalColorScaleConfig, useOrdinalColorScale } from '@stu-dev/nivo-colors'
import { castPointScale, castLinearScale, ScalePoint } from '@stu-dev/nivo-scales'
import {
    Variable,
    VariableWithScale,
    CommonProps,
