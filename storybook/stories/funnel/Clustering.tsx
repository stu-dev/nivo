...
import { ResponsiveWaffle } from '@stu-dev/nivo-waffle'
    ...
    return (
        <>
            ...
            >
                ...
                <code>@stu-dev/nivo-waffle</code> package to show clustering by gender, and the{' '}
                <code>Bar</code> component from <code>@stu-dev/nivo-bar</code> to show the repartition by
                age.
                <br />
