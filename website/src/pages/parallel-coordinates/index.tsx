...
import { ResponsiveParallelCoordinates, commonDefaultProps } from '@stu-dev/nivo-parallel-coordinates'
import { generateParallelCoordinatesData } from '@stu-dev/nivo-generators'
